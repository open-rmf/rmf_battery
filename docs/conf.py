...
breathe_projects = {
    'rmf_battery': '_build/doxygen/xml'
}
breathe_default_project = 'rmf_battery'

exhale_args = {
    'containmentFolder': './api',
    'rootFileName': 'rmf_battery_root.rst',
    'rootFileTitle': 'rmf_battery API',
    'doxygenStripFromPath': '../..',
    'createTreeView': True,
    'exhaleExecutesDoxygen': False,
    'exhaleDoxygenStdin': 'INPUT = ../rmf_battery/include',
}
